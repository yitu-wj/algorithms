...
import com.yitu.algorithms._12堆.BinaryHeap;
import com.yitu.algorithms._16并查集.GenericUnionFind;
...
public class ListGraph<V,E> extends Graph<V,E>{
    ...
    private Map<V,PathInfo<V,E>> dijkstra(V begin){
        ...
        while (!paths.isEmpty()){
            ...
            // 对它minVertex的outEdges进行松弛操作
            for (Edge<V, E> edge : minVertex.outEdges) {
                // 如果edge.to 已经离开桌面，就没有必要进行松弛操作
     ...
     * @param paths 存放其他点（对于dijkstra来说，就是还没有离开桌面的点）的最短路径信息
     */
